        ...
        <div class="main-content">
            ...
            <aside class="sidebar">
                <div class="sidebar-card">
                    ...
                    <ul>
                        <li><a target="_blank" classe="#">Les 10 plantes idéales pour débuter</a></li>
                        <li><a target="_blank" href="#">Atelier hydroponie du mois</a></li>
                        <li><a target="_blank" href="#">Nouveaux systèmes disponibles</a></li>
                        <li><a target="_blank" href="#">Témoignages de nos clients</a></li>
                        <li><a target="_blank" href="#">Guide des nutriments</a></li>
                    </ul>
                </div>
                ...
                <div class="sidebar-card">
                    ...
                    <ul>
                        <li><a target="_blank" href="#">Maintenir le pH optimal</a></li>
                        <li><a target="_blank" href="#">Changer l'eau efficacement</a></li>
                        <li><a target="_blank" href="#">Choix des substrats</a></li>
                        <li><a target="_blank" href="#">Contrôler la température</a></li>
                        <li><a target="_blank" href="#">Prévenir les maladies</a></li>
                    </ul>
                </div>
            </aside>
        </div>
